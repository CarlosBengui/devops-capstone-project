...
Este é um projeto capstone focado em práticas de DevOps, incluindo integração contínua (CI), entrega contínua (CD), automação de infraestrutura e monitoramento.

O objetivo do projeto é demonstrar a aplicação de ferramentas e processos DevOps para melhorar a eficiência no desenvolvimento, testes e implantação de aplicações.
...
## Objetivo
Construir um pipeline completo de desenvolvimento até produção, seguindo boas práticas de DevOps.
